...
class QuestionController extends Controller
{
    ...
    {   
        ...
        //id si gelen quizi buluyoruz daha sonra quiz modelindeki ilişki metodundan soru oluşturuyoruz.
    ...
    {
        $quiz = Quiz::find($quiz_id)->questions()->whereId($question_id)->delete();
        return redirect()->route('questions.index',$quiz_id)->withSuccess('Silme işlemi başarıyla yapıldı');
    }
}
